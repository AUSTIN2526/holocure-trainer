def main_info():
    return (
        {'value': 1090021872, 'address': 0x031418F0, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x10, 0x04], 'interlock':False},     # HP
        {'value': 1090021872, 'address': 0x031418F0, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x300, 0x04], 'interlock': False},  # Pick Range
        {'value': 1090021872, 'address': 0x031418F0, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x14A0, 0x04], 'interlock': False},  # ATK
        {'value': 1083127808, 'address': 0x031418F0, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x11D0, 0x04], 'interlock': False},  # Haste
        {'value': 1079558144, 'address': 0x031418F0, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x1350, 0x04], 'interlock': False}    # EX
    )

def LV_info():
    return (
        {'value': 1072693248, 'address': 0x03141678, 'offset': [0x48,0x10,0xD630, 0x04], 'interlock': True},    # Level up
        {'value': 1083127808, 'address': 0x03141678, 'offset': [0x48,0x10,0xD630, 0x04], 'interlock': True}    # Stop Level up                           
    )
