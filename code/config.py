def main_info():
    return (
        {'value': 1090021872, 'address': 0x03141880, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x10, 0x04], 'interlock':False},     # HP
        {'value': 1090021872, 'address': 0x03141880, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x800, 0x04], 'interlock': False},  # Pick Range
        {'value': 1090021872, 'address': 0x03141880, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x14A0, 0x04], 'interlock': False},  # ATK
        {'value': 1083127808, 'address': 0x03141880, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x11D0, 0x04], 'interlock': False},  # Haste
        {'value': 1079558144, 'address': 0x03141880, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x1840, 0x04], 'interlock': False}    # EX
    )

def LV_info():
    return (
        {'value': 1072693248, 'address': 0x03141608, 'offset': [0x48,0x10,0x3B20, 0x04], 'interlock': True},    # Level up
        {'value': 1083127808, 'address': 0x03141608, 'offset': [0x48,0x10,0x3B20, 0x04], 'interlock': True}    # Stop Level up                           
    )
