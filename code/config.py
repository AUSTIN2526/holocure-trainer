def main_info():
    return (
        {'value': 1090021872, 'address': 0x0314BB60, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x1630, 0x04], 'interlock':False},     # HP
        {'value': 1090021872, 'address': 0x0314BB60, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x1920, 0x04], 'interlock': False},  # Pick Range
        {'value': 1090021872, 'address': 0x0314BB60, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0xAC0, 0x04], 'interlock': False},  # ATK
        {'value': 1083127808, 'address': 0x0314BB60, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x7F0, 0x04], 'interlock': False},  # Haste
        {'value': 1079558144, 'address': 0x0314BB60, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x480, 0x04], 'interlock': False}    # EX
    )

def LV_info():
    return (
        {'value': 1072693248, 'address': 0x0314B8E8, 'offset': [0x48,0x10,0xC50, 0x04], 'interlock': True},    # Level up
        {'value': 1083127808, 'address': 0x0314B8E8, 'offset': [0x48,0x10,0xC50, 0x04], 'interlock': True}    # Stop Level up                           
    )
