def main_info():
    return (
        {'value': 99999.0, 'address': 0x0314BA20, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x1630, 0x00], 'interlock':False},     # HP
        {'value': 99999.0, 'address': 0x0314BA20, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x1920, 0x00], 'interlock': False},  # Pick Range
        {'value': 99999.0, 'address': 0x0314BA20, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0xAC0, 0x00], 'interlock': False},  # ATK
        {'value': 999.0, 'address': 0x0314BA20, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x7F0, 0x00], 'interlock': False},  # Haste
        {'value': 76.0, 'address': 0x0314BA20, 'offset': [0x70, 0x18, 0x170, 0x98, 0x48, 0x10, 0x1F90, 0x00], 'interlock': False}    # EX
    )

def LV_info():
    return (
        {'value': 1.0, 'address': 0x0314B7A8, 'offset': [0x48,0x10,0xC50, 0x00], 'interlock': True},    # Level up
        {'value': 999.0, 'address': 0x0314B7A8, 'offset': [0x48,0x10,0xC50, 0x00], 'interlock': True}    # Stop Level up                           
    )
